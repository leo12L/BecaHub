...
const mockRecommendedScholarships = [
  {
    ...
    description: "Becas para estudiantes de excelencia académica en programas STEM.",
  },
  {
    id: "2",
          ...
          <div className="p-8 max-w-7xl mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-gray-600">
                Bienvenido al portal de becas premium. Aquí encontrarás todas las
                oportunidades personalizadas para ti.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
              ...
              <div className="lg:col-span-2">
                <div className="mb-6 flex items-center justify-between">
                  ...
                  <button className="text-sm font-semibold text-gray-600 hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#800020] px-3 py-1 rounded"
                    onClick={() => {
