    ...
    >
      ...
      <div className="border-b border-gray-100 px-6 py-4">
        <div className="flex items-start justify-between gap-4">
          ...
          <div
            className="rounded-full px-3 py-1 text-center text-sm font-semibold whitespace-nowrap text-white"
      ...
      <div className="flex items-center justify-between gap-4 px-6 py-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="rounded-lg p-2 transition-colors hover:bg-gray-100 focus:ring-2 focus:ring-[#800020] focus:ring-offset-2 focus:outline-none"
          ...
          {/* Apply button */}
          <button
            className="rounded-lg px-4 py-2 font-semibold text-white transition-opacity hover:opacity-90 focus:ring-2 focus:ring-[#800020] focus:ring-offset-2 focus:outline-none"
            style={{
